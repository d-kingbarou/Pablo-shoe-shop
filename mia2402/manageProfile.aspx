<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="manageProfile.aspx.cs" Inherits="mia2402.manageProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <h2>Customer Manage Profile</h2>
        <p>&nbsp;</p>
    <p>Customer ID: 
...
&nbsp;</h4>
    ...
    <p>
        ...
        <asp:Button ID="btnUpdate" runat="server" Text="Update Profile" Width="242px" OnClick="btnUpdate_Click" />
    </p>
        <p>
